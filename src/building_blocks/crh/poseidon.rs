...
use ark_marlin::fiat_shamir::{poseidon::PoseidonSponge, AlgebraicSponge};
...
pub struct PoseidonCRHforMerkleTree<RO: Rng + CryptoRng + SeedableRng, F: PrimeField> {
    _rand: PhantomData<RO>,
    _field: PhantomData<F>,
}

impl<RO: Rng + CryptoRng + SeedableRng, F: PrimeField> CRHforMerkleTree
...
pub struct PoseidonCRHforMerkleTreeGadget<RO: Rng + CryptoRng + SeedableRng, F: PrimeField> {
    _rand: PhantomData<RO>,
    _field: PhantomData<F>,
}

impl<RO: Rng + CryptoRng + SeedableRng, F: PrimeField>
