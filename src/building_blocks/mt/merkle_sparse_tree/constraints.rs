...
mod test {
    ...
    use super::*;
    use crate::building_blocks::crh::poseidon::{
        PoseidonCRHforMerkleTree, PoseidonCRHforMerkleTreeGadget,
    };

    type H = PoseidonCRHforMerkleTree<ChaChaRng, Fq>;
    type HG = PoseidonCRHforMerkleTreeGadget<ChaChaRng, Fq>;
